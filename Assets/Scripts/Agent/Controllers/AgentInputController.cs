...
namespace Agent.Controllers
{
	...
	public class AgentInputController : MonoBehaviour
    {
        ...
        private void Attacking()
        {
            ...
            if (inputAttackL) {
                rpgCharacterController.StartAction("Attack", new RPGCharacterAnimsFREE.Actions.AttackContext("Attack", "Left"));
            } else if (inputAttackR) {
                rpgCharacterController.StartAction("Attack", new RPGCharacterAnimsFREE.Actions.AttackContext("Attack", "Right"));
            }
        }
